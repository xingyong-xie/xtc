...
class student(AbstractBaseUser):
    name = models.CharField(max_length=30, verbose_name="宝贝姓名")
    parent_name = models.CharField(max_length=30, verbose_name="家长姓名")
    address = models.CharField(max_length=50, verbose_name="家庭地址",  default="")
    phone = models.CharField(max_length=12, verbose_name="电话号码", default="")
